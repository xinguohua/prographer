...
from process.match.segment import unsorted_segment_sum
...
class GraphEncoder(nn.Module):
    ...
    def _build_model(self):
        ...
        input_dim = self._node_feature_dim
        for hidden_dim in self._node_hidden_sizes:
    ...
    def forward(self, edge_index, node_features, edge_features=None):
...
class GraphEmbeddingNet(nn.Module):
    ...
    def forward(self, x, edge_index, batch = None, graph_idx = None, edge_features = None, n_graphs = None):
        ...
        to_idx=edge_index[1]
        node_features, edge_features = self._encoder(edge_index, node_features, edge_features)
